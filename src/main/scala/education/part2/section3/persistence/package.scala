// src/main/scala/education/part2/section3/persistence/package.scala
package education.part2.section3

import javax.inject.{ Inject, Singleton }
import ixias.core.inject.IxiasModule
import education.part2.section3.persistence.table.*   // UserTable を参照
